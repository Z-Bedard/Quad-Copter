    ...
    private:
        ...
        void image_callback(const sensor_msgs::msg::Image::SharedPtr msg) {
            ...
            if(have_keyframe_ && !keyframe_descriptors_.empty() && !descriptors.empty()) {
                ...
                matcher_->match(keyframe_descriptors_, descriptors, matches);
                ...
                if(matches.size() < 10) {
                    ...
                    RCLCPP_INFO(this->get_logger(), "Features: %zu | Matches: %zu | Good Matches: %zu | Raw pairs: %zu | Undistorted pairs: %zu", keypoints.size(), matches.size(), good_matches.size(), keyframe_points.size(), keyframe_points_undistorted.size());
